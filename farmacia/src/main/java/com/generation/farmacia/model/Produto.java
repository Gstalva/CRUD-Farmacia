...
public class Produto {
	...
	@Size(min = 2, max = 100, message = "O atributo nome deve conter no minimo 2 e no maximo 100 caracteres")
	...
	@Size(min = 5, max = 150, message = "O atributo descricao deve conter no mínimo 5 e no máximo 150 caracteres")
